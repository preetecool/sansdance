...
class Engine {
  ...
  constructor(theRoot) {
    ...
    this.lives = 5; 
    this.lifeloss = document.getElementById("lifeloss");


    // this.playerLivesDiv =  document.querySelector(".playerlives") ;
    // for (let i = 0; i < this.lives; i++) {
    //   this.heart = new Image ()
    //   this.heart.src = "images/heart.png"
    //   this.heart.style.position = "relative";
    //   this.heart.style.display = "inline-block";
    //   this.heart.style.top = "0px"
    //         this.heart.style.top = "0px"

    //  this.playerLivesDiv.appendChild(this.heart);    
  ...
  gameLoop = () => {
    ...
    if (this.isPlayerDead() || this.score === 100) {
      window.alert('So many bats.. so much dancing!');
      return;
    }
